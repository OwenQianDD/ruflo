...
while [[ $# -gt 0 ]]; do
  case "$1" in
    ...
    -h|--help)
      ...
      echo ""
      echo "Dual-model headless multi-agent review."
      ...
      echo "  --source <kind>     Review source: pr, pr-markdown, local-file, slack"
      echo "  --input <value>     Source-specific input for non-PR reviews"
      echo "  --review-prompt     Custom instructions for review agents and coordinator"
